...
class WxpProfileActivity : WxpBaseActivity() {
    ...
    private val sectionData = mutableListOf<ProfileSection>()
    ...
    private fun setupUI() {
        ...
        adapter = ProfileAdapter(sectionData) { item ->
            item.action?.invoke()
        }
    ...
    private fun checkNotificationPermission() {
        val hasPermission = PermissionUtils.hasNotificationPermission(this)
        if (hasPermission) {
    ...
    private fun openPushCheckUrl() {
        ...
        WxpWebViewActivity.start(this, url)
    }
    ...
    private fun openUserAgreementUrl() {
        val url = "https://wxpusher.zjiecode.com/admin/agreement/index-argeement.html"
        WxpWebViewActivity.start(this, url)
    }
