//
//  WxpRemoveAccountViewController.swift
//  wxpusher
//
...
class WxpRemoveAccountViewController: UIViewController {
...
//        
        ...
        descriptionLabel.text = "你即将删除账号，删除以后，将无法在再登录，并且数据无法恢复。"
        ...
        inputTextField.placeholder = "请输入【删除账号】4个汉字来确认你的操作"
        ...
        confirmButton.setTitle("确认删除", for: .normal)
        confirmButton.titleLabel?.font = .systemFont(ofSize: 17, weight: .semibold)
        confirmButton.backgroundColor = .systemGray4
...
extension WxpRemoveAccountViewController: UITextFieldDelegate {
