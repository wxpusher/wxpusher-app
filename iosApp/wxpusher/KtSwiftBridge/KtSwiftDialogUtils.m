...
// 默认初始化方法
- (instancetype)init {
    return [self initWithTitle:nil message:nil leftText:nil leftBlock:nil rightText:nil rightBlock:nil];
}

- (nonnull instancetype)initWithTitle:(nullable NSString *)title rightText:(nullable NSString *)rightText {
    return [self initWithTitle:title message:nil leftText:nil leftBlock:nil rightText:rightText rightBlock:nil];
}
